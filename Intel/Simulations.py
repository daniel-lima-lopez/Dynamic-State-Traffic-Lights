...
class SimStateNN:
    def __init__(self, seed, gen, steps=1000, gui=False, verbose=False, worst=4000):
...
if __name__ == '__main__':
    ...
    '''random.seed(1) # semilla de semaforos

    # instanciamos la simulacion
    test = SimStateRandom(seed=78, gui=False, verbose=False)
